...
public class MainTest {
    ...
    public void measureMaxPerformance() {
        ...
        long end = System.nanoTime();
        double duration = (end - start) / 1_000_000_000.0;
        System.out.println("max function took " + duration + " seconds");
    }
    @Test
    public void measureSumPerformance() {
        ...
        long end = System.nanoTime();
        double duration = (end - start) / 1_000_000_000.0;
        System.out.println("sum function took " + duration + " seconds");
    }
    @Test
    ...
    public void measureMultPerformance() {
        ...
        long end = System.nanoTime();
        double duration = (end - start) / 1_000_000_000.0;
        System.out.println("mult function took " + duration + " seconds");
    }
    @Test
